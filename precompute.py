"""Pre-compute all expensive data used by the Streamlit app and save to a pickle file.

Run once (or whenever source data changes):
    python precompute.py

The app will then load the pickle instead of recomputing everything.
"""
...
OUTPUT_PATH = Path(__file__).resolve().parent / "data" / "precomputed.pkl"
...
def main() -> None:
    ...
    print("Building frontier payload...")
    ...
    payload = {
        ...
        "selected_intraday_prices_empty": selected_intraday_prices.empty,
